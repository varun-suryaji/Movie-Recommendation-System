...
data = pd.read_csv(r'C:\Users\varun\Desktop\Project\Movie-Recommender-System-master\data.csv')
...
data.to_csv(r'C:\Users\varun\Desktop\Project\Movie-Recommender-System-master\data.csv',index=False)